					...
					<div id="int-main-container">
						<div id="int-main-section">
							...
							<div class="int-section">
								...
								<div class="w-iframe">
									<iframe width='100%' height='100px' src="http://ad.ad4989.co.kr/cgi-bin/PelicanC.dll?impr?pageid=02Ce&out=iframe"  marginwidth="0" marginheight="0" hspace="0" vspace="0" frameborder="0" scrolling="no" ></iframe>
								</div>
                            ...
                            <div class="int-section"><!-- 새로 들어가는 만화놈2 360?-->
								...
								<div class="S-iframe">
									<iframe width="100%" height="340px" src="http://ad.ad4989.co.kr/cgi-bin/PelicanC.dll?impr?pageid=02kY&out=iframe" frameborder="0" scrolling="no" ></iframe>
								</div>
							</div><!-- int-section -->
