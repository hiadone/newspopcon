	...
	<section>
		<div class="panel" id="ARTICLE1" name="ARTICLE1">
			<div class="panel_header">
				<div class="container">
					<div class="row">
						<font color="009edd"> 오늘의 인기앱 뉴스 </font>  <div class="pull-right"><img src="image/arrow_right.png" class="arrow_more"></div>
					</div>
				</div>
			</div>
	...
	<section>
		<div class="panel" id="ARTICLE2" name="ARTICLE2">
			<div class="panel_header">
				<div class="container">
					<div class="row">
						<font color="009edd">금주의 추천 APP</font> <div class="pull-right"><img src="image/arrow_right.png" class="arrow_more"></div>
					</div>
				</div>
			</div>
			<div class="panel_body">
	...
	<section>
		<div class="panel" id="ARTICLE3" name="ARTICLE3">
			<div class="panel_header">
				<div class="container">
					<div class="row">
						<font color="009edd"> 최신 히트게임</font>  <div class="pull-right"><img src="image/arrow_counter.png" class="arrow_more"></div>
					</div>
				</div>
			</div>
			<div class="panel_body">
	...
	<section>
		<div class="panel" id="ARTICLE4" name="ARTICLE4">
			<div class="panel_header">
				<div class="container">
					<div class="row">
						<font color="009edd">라이프 스타일</font> <div class="pull-right"><img src="image/arrow_counter.png" class="arrow_more"></div>
					</div>
				</div>
			</div>
			<div class="panel_body">
	...
	<section>
		<div class="panel" id="ARTICLE6" name="ARTICLE6">
			<div class="panel_header">
				<div class="container">
					<div class="row">
						<font color="009edd">인기앱 즐겨찾기</font>  <div class="pull-right"><img src="image/arrow_counter.png" class="arrow_more"></div>
					</div>
				</div>
			</div>
			<div class="panel_body">
