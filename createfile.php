...
$press = isset($_REQUEST["press"]) ? $_REQUEST["press"] : "index";

switch ($press) {

    case "index": // 아주경제
           $brd_key='hiadone_newspopcon';
...
if($db_db->pquery($query)){
    ...
    while($r = $db_db->fetchrow()) {
        ...
        $post_content.="if($"."sType=='".$r['post_md']."'){\n";
...
$filename=dirname(__FILE__).'/common/type_'.$press.'.php';
            echo $filename."<br>";
